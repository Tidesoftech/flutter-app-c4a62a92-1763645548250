...
void main() {
  runApp(PremierAirportTransitServiceApp());
}

class PremierAirportTransitServiceApp extends StatelessWidget {
  final String initialUrl = 'https://p-a-t-s.com';

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Premier Airport Transit Service',
      theme: ThemeData(
...
class _WebViewWrapperState extends State<WebViewWrapper> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Premier Airport Transit Service'),
        actions: [
          IconButton(
